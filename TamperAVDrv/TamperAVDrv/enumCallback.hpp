...
//function
BOOLEAN EnumProcessObCallback(bool);
BOOLEAN EnumThreadObCallback(bool);
static CHAR originalCode[2000][3];
//VOID ThreadEnumProcessObCallback();
//VOID ThreadEnumThreadObCallback();
